...
const ChatLog = ({ chatStore, isBelowLgScreen, isBelowMdScreen, isBelowSmScreen, searchQuery }: ChatLogProps) => {
  // Props
  ...
  return (
    ...
    >
      <CardContent className='p-0'>
        {activeUserChat &&
          formatedChatData(messagesToDisplay, profileUser).map((msgGroup, index) => {
