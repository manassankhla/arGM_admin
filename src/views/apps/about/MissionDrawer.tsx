...
const MissionDrawer = ({ open, handleClose, onSave, initialData }: Props) => {
        ...
        if (open) {
            if (initialData) {
                reset({
                    ...
                    image: null // Cannot enforce file object persistence in this demo
                })
            } else {
                reset({
                    title: '',
    ...
    return (
        ...
        >
            <div className='flex items-center justify-between pli-5 plb-4'>
                <Typography variant='h5'>{initialData ? 'Edit Item' : 'Add New Item'}</Typography>
