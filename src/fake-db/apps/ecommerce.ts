  ...
  contacts: [
    {
      ...
      subject: 'New Crane Technology',
      message: 'Interested in your latest heavy lifting cranes for our new facility.'
    },
    {
      id: 2,
      title: 'Ms',
      ...
      mobile: '+1 999 888 7778',
      purpose: 'General Enquiry',
      subject: 'Maintenance Contract',
      message: 'Requesting details about annual maintenance contracts for existing machinery.'
    },
    {
      id: 3,
      title: 'Mr',
      ...
      telephone: '+1 000 000 0002',
      mobile: '+1 999 888 7779',
      purpose: 'Partnership',
      subject: 'Joint Venture',
      message: 'Proposal for a joint venture in construction equipment manufacturing.'
    },
     {
      id: 4,
      title: 'Mrs',
      ...
      subject: 'Crane for Exhibit Installation',
      message: 'Need a specialized crane for installing a large sculpture next month.'
    },
     {
      id: 5,
      title: 'Dr',
      ...
      mobile: '+1 917 555 6789',
      purpose: 'Sales',
      subject: 'Medical Equipment Transport',
      message: 'Inquiry about cranes suitable for lifting sensitive medical equipment to higher floors.'
    }
  ],
  faqs: [
    {
      id: 1,
      title: 'What types of cranes do you offer?',
      description: 'We offer a wide range of cranes including mobile cranes, tower cranes, crawler cranes, and overhead cranes suitable for various construction and industrial needs.'
    },
    {
      id: 2,
      title: 'Do you provide crane rental services?',
      description: 'Yes, we provide flexible crane rental services with or without operators. Our fleet is well-maintained and ready for deployment.'
    },
    {
      id: 3,
      title: 'What safety certifications do your operators have?',
      description: 'All our operators are NCCCO certified and undergo regular safety training to ensure the highest standards of safety on every job site.'
    },
    {
      id: 4,
      title: 'Can you handle heavy lift projects?',
      description: 'Absolutely. We specialize in heavy lift projects and have the engineering expertise and equipment to handle loads exceeding 500 tons.'
    },
    {
      id: 5,
      title: 'What is your service area?',
      description: 'We primarily serve the North American region but are capable of deploying equipment and teams for international projects upon request.'
    }
  ],
  products: [
    {
